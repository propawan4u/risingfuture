 <?php
    ...
    if (!empty($getX4slots1)) {
        // print_r($getX4slots1);
        // exit;
        foreach (array_filter($getX4slots1[0]) as $val) {
     ...
     <div class=" row">
         <div class="col-md-3 mx-auto">
             <div class="form-group">
                 <select name="cycle" id="get_cycle_id_by_x4_slot" class="form-control">
                     <?php
                        if (empty($getX4slots1)) { ?>
                         <option> Cycle 0 </option>
                         <?php  } else {
                            foreach ($getX4slots1 as $key => $cyc) {
                            ?>
             ...
             <input type="hidden" id="slotId" name="slotId" value="<?php echo $Slots = $this->uri->segment(2); ?>">
         </div>
     </div>
     <div class="row" id="x4_cycle_id_slots">
