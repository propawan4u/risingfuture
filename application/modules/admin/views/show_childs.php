                                          ...
                                          <?php
                                            ...
                                            ?>
                                                  <tr>
                                                      ...
                                                      <!-- <a href="<?php //echo base_url() 
                                                                    ?>show-childs-dettails/<?php //echo $show['uid']; 
                                                                                            ?>"> -->
                                                      ...
                                                      <td>
                                                          ...
                                                          <?php } else { ?>
                                                              <p class="text-danger status-shad" style="text-shadow: 2px 2px lightgray;">Dacitve</p>
                                                          <?php } ?>
                                                      </td>
                                                      ...
                                                      <td>
                                                          <!-- <a href="<?php //echo base_url() 
                                                                        ?>edit-password/<?php //echo $show['uid']; 
                                                                                        ?>" class="btn bg-info btn-sm"> -->
                                                          <!-- <i class="fa fa-key text-primary"></i> -->
                                                          <!-- </a> -->
                                                          <!-- <a href="<?php //base_url() 
                                                                        ?>show-childs-dettails/ -->
                                                          <!-- <?php //echo $show['userID']; 
                                                                ?>" class="btn bg-info btn-sm"> -->
                                                          <!-- <i class="fa fa-eye "></i> -->
                                                          <!-- </a> -->
                                                          <!-- <a href="" class="btn bg-info btn-sm"><i class="fas fa-info"></i></a> -->
                                                          <!-- <a href="<?php //base_url() 
                                                                        ?>edit-user/<?php //echo $show['uid'] 
                                                                                    ?>" class="btn bg-info btn-sm"> -->
                                                          <!-- <i class="fa fa-edit" style="padding-left: 5px; color:blue;"></i> -->
                                                          <!-- </a> -->
                                                          <!-- <a href="<?php //echo base_url() 
                                                                        ?>delete-user/<?php // $show['uid'] 
                                                                                        ?>" class="btn bg-info btn-sm"><i style="color: red;margin-left:5px;" class="fa fa-trash" style="margin-left: 9px;"></i></a> -->
