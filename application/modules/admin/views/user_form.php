                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="form-group ex">
                                        ...
                                        <input readonly="" name="parent_name" id="parent_name" value="<?php //echo set_value('parent_name'); 
                                                                                                        ?>" placeholder="Please Enter Parent Id" class="form-control shad">
