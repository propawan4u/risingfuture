              ...
              <div class="card-body">
                <div class="row">
                  <div class="form-group ex col-md-4">
                    ...
                    <input readonly class="form-control shad" required name="user_email" placeholder="Enter User E-mail" value="<?php echo $fetch[0]['email']; ?>">
                  </div>
                  <div class="form-group ex col-md-4">
                    <label><b>Contact</b></label>
                    <input type = "number" maxlength = 10 class="form-control shad" required name="contact" placeholder="Enter User E-mail" value="<?php echo $fetch[0]['contact']; ?>">
                  </div>
                </div>
                <div class="row">
                  <div class="form-group ex  col-md-4">
                    <label><b>Parent Id</b></label>
                    <input readonly name="parent_id" required value="<?php echo $fetch[0]['parent_id']; ?>" id="parent_id" placeholder="Enter Parent Id" class="form-control shad">
                  ...
                  <div class="form-group ex  col-md-4">
                    ...
                    <select name="status" id="" class="form-control">
                      ...
                      <option value="1" <?php if ($fetch[0]['status'] == 1) {
                                          echo "selected";
                                        } else {
                                          echo "";
                                        } ?>>Active</option>
                      <option value="0" <?php if ($fetch[0]['status'] == 0) {
                                          echo "selected";
                                        } else {
                                          echo "";
                                        } ?>>Dacitve</option>
